...
/* 1. структура Person:
 - определим структуру Person, которая содержит ТРИ свойства:
 'name' - строка для имени хоббита
 'sername' -  строка для фамилии хоббита
 2. функция creatPersons():
 - создает пустой массив 'hobbits'
 - добавляет в массив 3 экземпляра Person с различными значениями имени и фамилии
 3. функция printHobbitsNames():
 - принимает массив хоббитов и выводит инфу о каждом с помощью цикла 'for'
 4. ОСНОВНОЙ КОД:
 - вызывает функцию для создания персонажей и выводит инфу о хоббитах
 РЕЗУЛЬТАТ:
 при выполнении кода -> вывод инфы о трех хоббитах в формате:
 Имя: Bilbo, Фамилия: Baggins
 Имя: Frodo, Фамилия: Torbins
 Имя: Peregrin, Фамилия: Took */
