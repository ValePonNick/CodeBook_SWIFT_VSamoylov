...
func absValue(array: [Int]) -> [Int] {
    /* используй метод '.map' и функцию 'abs' для преобразования каждого элемента в абсолютное значение */
...
/*
 ЗАДАЧА 7: напиши функцию, которая добавляет заданную строку к КАЖДОЙ строке в массиве. Используй метод '.map'. Напр.: есть массив "apple", "banana' -> добавь к каждой строке "fruit" => результат д.б.: "apple fruit", "banana fruit" */

//ЗАДАЧА 8: напиши функцию, которая возводит все числа в массиве в куб. Используй метод '.map'
