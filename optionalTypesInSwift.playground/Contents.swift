...
1. NB: ТАКОЙ рабочий код НЕ ПИШУТ! ТАБУ! только в учебных целях/примерах/документации от Apple - не д.б. принудительного извлечения опционалов для джуна
...
// ОПЦИОНАЛЬНАЯ ПРИВЯЗКА
 ...
 struct Person {
     let name: String
     var surname: String? // юзер м. указать фамилию / не захотел выкладывать свою фамилию
...
var tim = Person(name: "Tim", surname: "Cook")
let dogName: String? = "Rex"
var dogAge: Int?
...
// что можем сделать?
// спасет опциональная привязка
// если значение имеется ->
